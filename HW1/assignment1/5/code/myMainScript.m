...
J1 = double(imread('../images/T1.jpg')); % reading the images
J2 = double(imread('../images/T2.jpg'));
J3 = imrotate(J2, 28.5, 'crop'); % making the rotated image, interpolation method used is 'nearest neighbour'
%% (a) part
imwrite(uint8(J3), '../images/T2_rotated.jpg');
...
saveas(gcf,'../images/Joint_hist_JE.png');